  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      if (tab === 'admin') {
        ...
        setSuccess('Password reset link sent to your admin email.');
      } else {
        await api.post('/api/auth/forgot-password', { email });
          ...
          <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                tab === 'admin' ? 'bg-white shadow text-blue-600' : 'text-gray-500'
              }`}
            >
              🔐 Admin Login
            </button>
            ...
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${
                tab === 'employee' ? 'bg-white shadow text-blue-600' : 'text-gray-500'
              }`}
            >
              👤 Employee Login
            </button>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder={tab === 'admin' ? 'admin@crm.com' : 'employee@company.com'}
        ...
        {view === 'forgot' && (
          <form onSubmit={handleForgotPassword} className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-800">
              {tab === 'admin' ? '🔗 Admin Password Reset' : '📧 Employee Password Reset'}
            </h2>
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white rounded-lg py-2.5 font-medium hover:bg-blue-700 disabled:opacity-50"
            >
              {loading ? 'Sending...' : tab === 'admin' ? 'Send Reset Link' : 'Send OTP'}
            </button>
